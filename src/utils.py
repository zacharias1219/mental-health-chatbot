def crisis_response():
    """
    Returns a crisis management message advising immediate help.
    Customize hotline numbers and links as per regional requirements.
    """
    return (
        "I'm really sorry that you're feeling this way. It seems you might need immediate help. "
